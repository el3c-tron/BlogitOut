...
const register = async (req , res) => {
    ...
    try{
        ...
        if(!fname || !lname || !username || !password || !cpassword){
            res.render("register" , {err:"Fill all Fields !!" , fname , lname , username , password , cpassword});
            return;
        }
        if(password !== cpassword){
            res.render("register" , {err:"Confirm Password doesn't Match" , fname , lname , username});
            return;
        }
        ...
        if(user){
            res.render("register" , {err:"UserName already Exists" , fname , lname , password , cpassword});
            return;
        }
